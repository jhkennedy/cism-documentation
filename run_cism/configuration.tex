...
%% which_ho_approx
    ...
    \begin{tabular}[t]{lp{0.85\linewidth}}
      ...
      {\bf 2} & Blatter-Pattyn with both vertical-shear and horizontal-plane and shear stresses (uses glissade\_velo\_higher) \\
       2 & Depth-integrated (L1L2) approximation, with both vertical shear and horizontal-plane stresses (uses glissade\_velo\_higher; requires \texttt{which\_ho\_precond} $<=$1) \\
    \end{tabular}\\  
%% which_ho_precond
