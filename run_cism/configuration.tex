...
%%%% Options
    ...
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{Parameters set in this section determine how various components of the ice sheet model are treated.  Configuration number options with a * after them are specific to the higher-order dycores (Glissade/Glam).}\\
    \hline
%% dycore
    \texttt{dycore} & 
...
%% restart
 ...
 %%%% HIGHER-ORDER OPTIONS
    ...
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{Options set in this section determine how various components of the higher-order extensions to the ice sheet model (Glissade/Glam) are treated. Defaults are indicated in bold. These options have no effect on the Shallow-Ice (Glide) dycore.  As noted above, higher-order model options are currently NOT scientifically supported.}\\
    \hline
%% which_ho_nonlinear
...
%%%% PARAMETERS
    ...
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{Set values for various parameters.  Parameters with a * after them are specific to the higher-order dycores (Glissade/Glam).}\\
    \hline
