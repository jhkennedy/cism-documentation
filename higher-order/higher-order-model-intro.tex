...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.9\columnwidth]{\dir/figs/StressBalance.eps}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.9\columnwidth]{\dir/figs/HOeqns.eps}
   \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.9\columnwidth]{\dir/figs/ISMPhylogeny.eps}
   \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.9\columnwidth]{\dir/figs/GIS.eps}
   \end{center}
