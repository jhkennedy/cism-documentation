...
Note that if you encounter an `unable to open display' error when running \texttt{ncview},
...
\begin{mdframed}[style=mac] % V==============MAC================V
For building on a Mac, you should be able to build the code by doing the following:
...
\href{mailto:cism-devel+subscribe@googlegroups.com}{developers} lists
\footnote{cism-users+subscribe@googlegroups.com -or- cism-devel+subscribe@googlegroups.com} if you have questions 
...
Note that building a parallel version of CISM that includes Trilinos requires setting the  
\begin{verbatim}
-D CISM_USE_TRILINOS 
\end{verbatim}
